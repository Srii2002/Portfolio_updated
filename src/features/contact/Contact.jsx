        ...
        <div className="flex flex-col xl:w-1/2 xl:pl-10">
          ...
          >
            <div className="flex flex-col">
              <label className="text-base font-semibold md:text-lg" htmlFor="name">
                NAME
              </label>
              <input
                className="input"
              ...
              />
              <p className="error text-sm text-red-600">{errors.name?.message}</p>
            </div>
            <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              <label className="text-base font-semibold md:text-lg" htmlFor="textmessage">
                MESSAGE
              </label>
              <textarea
                ...
                {...register("textmessage", {
                  ...
                  validate: {
                    isLessThanfiveChar: (fieldValue) => {
                      return fieldValue.length > 4 || "Should be of minimum 5 characters";
                    },
                  },
                })}
              ></textarea>
              <p className="error text-sm text-red-600">{errors.textmessage?.message}</p>
            </div>
            <button
              type="submit"
